...
docker run --privileged=true -d --link namenode:namenode -e namenode_ip=$IP_namenode -e AMBARI_SERVER=namenode --dns 8.8.8.8 -p 11000:11000 -p 2181 -p 50111:50111 -p 9083 -p 10000 -p 9999:9999 -p 9933:9933 -p 22 -p 8440 -p 8441 --name hiveserver -h hiveserver -i -t hwxu/ambari_2.1_agent_node
...
do
nodename="node$i"
docker run --privileged=true -d --dns 8.8.8.8 -h $nodename --name $nodename -p 22 --link namenode:namenode -e AMBARI_SERVER=namenode -p 8440 -p 8441 -i -t hwxu/ambari_2.1_agent_node
